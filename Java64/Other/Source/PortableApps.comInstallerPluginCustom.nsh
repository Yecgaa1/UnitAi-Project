...
!macro CustomCodePostInstall
	Rename "$INSTDIR\jre1.8.0_221\bin" "$INSTDIR\bin"
	Rename "$INSTDIR\jre1.8.0_221\lib" "$INSTDIR\lib"
	Rename "$INSTDIR\jre1.8.0_221\COPYRIGHT" "$INSTDIR\COPYRIGHT"
	Rename "$INSTDIR\jre1.8.0_221\LICENSE" "$INSTDIR\LICENSE"
	Rename "$INSTDIR\jre1.8.0_221\README.txt" "$INSTDIR\README.txt"
	Rename "$INSTDIR\jre1.8.0_221\release" "$INSTDIR\release"
	Rename "$INSTDIR\jre1.8.0_221\THIRDPARTYLICENSEREADME.txt" "$INSTDIR\THIRDPARTYLICENSEREADME.txt"
	Rename "$INSTDIR\jre1.8.0_221\THIRDPARTYLICENSEREADME-JAVAFX.txt" "$INSTDIR\THIRDPARTYLICENSEREADME-JAVAFX.txt"
	Rename "$INSTDIR\jre1.8.0_221\Welcome.html" "$INSTDIR\Welcome.html"
	RMDir "$INSTDIR\jre1.8.0_221"
